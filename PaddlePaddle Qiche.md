...
### 角度3： 阅读理解问题
如果看成是阅读理解问题， 那么就是从Conversation中找出能回答Problem的答案， 由于目前的阅读理解数据集答案的长度通常比较短（一般是几个单词），所以目前state of the art的作法是根据Problem，从Context中选择一段作为答案，模型只要输出开始和结束的位置即可。 但是这个任务的report长度很长，
...
F0ZWdvcmllczogRExcbiIsImhpc3RvcnkiOlstMTU0NjEyNjAz
LDE0NzYwODg0ODksNzE5Mjc4MjkxLC0yMDEzMDA5MTMzLC0yMT
cwNDQxMzAsLTU4NDcxOTEyMCwtMTI0NDIwNzAyMSwxNjY3ODA3
NTYsLTI0Mzk1NDU2XX0=
-->