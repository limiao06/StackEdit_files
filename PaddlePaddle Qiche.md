...
### 角度3： 阅读理解问题
如果看成是阅读理解问题， 那么就是从Conversation中找出能回答Problem的答案， 由于目前的阅读理解数据集答案的长度通常比较短（一般是几个单词），所以目前state of the art的作法是根据Problem，从C中选择一段
...
F0ZWdvcmllczogRExcbiIsImhpc3RvcnkiOlsxNDc2MDg4NDg5
LDc2NjMwNDEwOSw3MTkyNzgyOTEsLTIwMTMwMDkxMzMsLTIxNz
