...
4. 在用seq2seq产生自然语言时， 引入reinforcement learning通常是非常有效的，可以解决训练和测试目标不匹配的问题（训练是看每个时刻的分类误差， 而测试时是用ROUGE， BLEU之类的整句的评估算法）， 但是同样
paddle心得
...
F0ZWdvcmllczogRExcbiIsImhpc3RvcnkiOlstMTg3NTUzODcx
OSwtNDU0ODU4NDA4LC0xMTk3ODk2NjI2LDIwODU3MTE1NzgsLT
