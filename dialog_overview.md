...
在介绍对话系统的基本组成结构之前，我认为有必要先理解一下对话系统的大致工作过程。为了帮助用户在某个特定领域达成某一目的，对话系统的工作过程很自然的可以大致分为两步，第一步是明确用户的目的，第二步是明确用户目的后，帮助用户完成目的。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg3OTI5Mjc1Nyw1NTY3Nzg0ODEsNzQxNj
